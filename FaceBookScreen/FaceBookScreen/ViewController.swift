...
class ViewController: UIViewController {
    ...
    textFieldSeparatorLine.widthAnchor.constraint(equalToConstant: 270).isActive = true
        textFieldSeparatorLine.topAnchor.constraint(equalTo: orLable.bottomAnchor, constant: 2).isActive = true
